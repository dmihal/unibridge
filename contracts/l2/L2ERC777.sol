 ...
 * Runtime target: OVM
 */
contract L2ERC777 is IERC777, IERC20, IL2Token {
    ...
    */
    ...
    function withdraw(address _destination, uint256 _amount) external override {
        ...
        IL2TokenBridge(bridge).withdraw(l1Address, _destination, from777to20(l1Decimals, _amount));
    }
    ...
    function migrate(uint256 _amount, address _target) external override {
        _burn(msg.sender, _amount, "", "");
        IL2TokenBridge(bridge).migrate(l1Address, _target, msg.sender, from777to20(l1Decimals, _amount));
    }
     ...
     */
    function mint(address _destination, uint256 _amount) external override onlyBridge {
